...
function loadSavedClientId() {
    const clientId = '28b16bdddc594e77b0fd37826ff1a881';
...
async function exchangeCodeForToken(code) {
    ...
    if (!response.ok) {
        setStatus('Spotify authorization failed. Check your Client ID and redirect URI.', true);
        return;
    }
...
function logout() {
    ...
    elements.compatibilityScore.textContent = '--';
    elements.compatibilityText.textContent = 'Add your manual preferences after connecting Spotify to preview a compatibility score.';
